...
public class ExchangeRateImporter {
    ...
    @Autowired
    public ExchangeRateImporter(final ExchangeRateRepository exchangeRateRepository, final CurrencyConverterAPIService currencyConverterAPIService) {
    ...
    public void scheduleTask() {
        ...
        ExchangeRateAPITask st = new ExchangeRateAPITask(exchangeRateRepository, currencyConverterAPIService);
